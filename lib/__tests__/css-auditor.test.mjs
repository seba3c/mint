...
describe('CssAuditor', () => {
  it('audit returns parsed JSON object', async () => {
    ...
    const auditor = new CssAuditor(mockClient, { audit: 3000, parse: 4000, export: 6000 })
...
describe('buildCssAuditorFromSettingsAndFlags', () => {
  it('returns CssAuditor wrapping AnthropicLlmClient for anthropic name', () => {
    const testSettings = {...settings, llmProvider: {...settings.llmProvider, apiKey: 'sk-test'}} 
  ...
  it('throws for unknown provider name', () => {
    const testSettings = {...settings, llmProvider: {...settings.llmProvider, name: 'unknown-provider'}} 
